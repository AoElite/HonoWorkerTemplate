...
export class WorkerEnv extends Context.Service<WorkerEnv, CloudflareBindings>()("WorkerEnv") {}

export const workerEnvLayer = (env: CloudflareBindings) => Layer.succeed(WorkerEnv, env);
